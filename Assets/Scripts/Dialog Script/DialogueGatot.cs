...
public class DialogueGatot : MonoBehaviour
{
    public GameObject objectToShow;
    public GameObject hiddenGameObject;
    public GameObject hiddenFragment;
    public GameObject hideGatot;
   ...
   void CloseDialog()
{
    ...
    // Destroy the hideGatot GameObject
    if (hideGatot != null)
    {
        Destroy(hideGatot);
    }

    hiddenFragment.SetActive(true);
}
}
